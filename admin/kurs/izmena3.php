				...
				<div class="modal-content">
					<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
						<div class="modal-header">						
							<h4 class="modal-title">Izmena podataka o kursa</h4>
						...
						<div class="modal-body">							
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" value="<?php echo $naziv; ?>" name="nazivZaIsmeniti" required>
							</div>
							<div class="form-group">
								<label>Godina</label>
								<span id="greska"><?php echo $prezimeErr;?></span>
								<input type="text" class="form-control" value="<?php echo $godina; ?>" name="godinaZaIsmeniti" required>
							</div>	
						</div>
